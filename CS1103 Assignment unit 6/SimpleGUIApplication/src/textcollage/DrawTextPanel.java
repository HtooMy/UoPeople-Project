...
public class DrawTextPanel extends JPanel {
	...
	public void doMousePress(MouseEvent e) {
		...
		// Create random background transparency
	...
	private void saveFile() {
		File saveAs = fileChooser.getOutputFile(this, "Save As", "TextCollage.txt");
		try {
			PrintWriter out = new PrintWriter(saveAs);
			out.println("New Text College file");
			out.print(canvas.getBackground().getRed());
			out.print(canvas.getBackground().getGreen());
			out.print(canvas.getBackground().getBlue());
			if (theString != null) {
				for (DrawTextItem s : theString) {
			...
			JOptionPane.showMessageDialog(this, "Cannot write to the file " + saveAs + ".");
	...
	private void openFile() {
		...
		try {
			...
			if (!in.nextLine().equals("Next text colllage file")) {
			...
			JOptionPane.showMessageDialog(this, "Cannot read the file" + openFile);
			System.out.println("Error message: " + e);
		}
	}
}
