...
public class GuiDemo extends JFrame {
	...
	public GuiDemo() {
		...
		drawPanel.setBackgroundImage(Util.getImageResource("resources/images/time.jpeg"));
	...
	private class ChooseBackgroundAction extends AbstractAction {
		...
		ChooseBackgroundAction(String text) {
			...
			if (text.equals("Color...")) {
				BufferedImage colorBuffer = new BufferedImage(32, 32, BufferedImage.TYPE_INT_ARGB);
	...
	private JToolBar makeToolBar() {
		...
		tbar.add(new ChooseBackgroundAction("time"));
